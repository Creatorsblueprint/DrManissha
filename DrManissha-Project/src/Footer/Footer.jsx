      ...
      <div className={styles.container}>
        <div className={styles.brandCol}>
          ...
          <p className={styles.tagline}>
            Integrating science and soul to help women navigate midlife hormonal
            transitions with clarity, confidence, and vitality.
          </p>
          <div className={styles.socialIcons}>
            <a
              href="https://www.youtube.com/@hairhormonecoach"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/hairhormonecoach"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialIcon}
            >
            ...
            <a
              href="https://www.tiktok.com/@drmanissha"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialIcon}
            >
            ...
            <a
              href="https://ae.linkedin.com/in/dr-manissha-p-48a007185"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialIcon}
            >
